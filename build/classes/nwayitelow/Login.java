...
public class Login {
   ...
   public static boolean checkUserName(String username){
    ...
    public String returnLoginStatus(boolean isSuccess) {
        String message = isSuccess ?  "Username or password incorrect, please try again.":"Welcome "+ JRegister.firstname + " " + JRegister.lastname + " it is great to see you again." ;
